...
| UpnpUrl | UPnP 设备描述文件 (XML) 的 URL，用作绕过 SSDP 发现过程<br>通常在 Bridge 模式，或在路由器上运行容器时需要 | 无 |
...
| JvmArgs | [JVM 其他参数](https://docs.oracle.com/cd/E22289_01/html/821-1274/configuring-the-default-jvm-and-java-arguments.html)<br>`-Xms16m -Xmx512m` 可限制启动内存 16M，最大内存 512M | 无 |
